...
//           viewDepatments().then(userPrompts);
//           break;
//         case "view all roles":
//           viewRoles().then(userPrompts);
//           break;
//         case "view all employees":
//           viewEmployees().then(userPrompts);
//           break;
//         case "add a department":
//           addDepatment();
//           break;
//         case "add a role":
//           addRole().then(userPrompts);
//           break;
//         case "add an employee":
//           addEmployee().then(userPrompts);
//           break;
//         case "update an employee role":
//           updateEmployeeRole().then(userPrompts);
//           break;
//       }
//     });
// }
